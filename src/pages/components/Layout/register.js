...
function Login() {
    ...
    return ( 
        ...
        <div className="flex justify-between  w-48">
            <button onClick={() => {setIsLog(true)}} className="bg-white hover:bg-gray-300  text-blue-600 font-bold py-2 px-4">Sign up</button>
            <button onClick={() => {setIsLog(false)}} className="bg-white hover:bg-gray-300 text-blue-600 font-bold py-2 px-4">Log in</button>   
        </div>
        {isLog && 
        <Register>
    ...
    <div>
        ...
        <input type="text" name="text" id="text" placeholder="username" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required/>
    </div>
    <div>
        <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your password</label>
        <input type="password" name="password" id="password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required/>
